...
--Not taken any training sessions
--number of projects assigned currently


SELECT 
    e.employee_id, 
    e.employee_name, 
    COUNT(DISTINCT p.project_id) AS current_projects 
FROM 
    employees e 
LEFT JOIN 
    training_sessions t ON e.employee_id = t.employee_id 
